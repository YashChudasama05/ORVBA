...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($name) && !empty($email) && !empty($feedback) && !is_numeric($name))
		{

			//save to database
			$user_id = random_num(20);
			$query = "insert into feedback (id,name,email,feedback) values ('$id','$name','$email','$feedback')";

			mysqli_query($con, $query);

			header("Location: thankyouf.php");
			die;
		}else
		{
                ...
                <table border="0" width="85%" cellpadding="15" cellspacing="0" align="center">
					...
					<tr>
                    	...
                    	<div class="container mt-4">
							...
							<hr>
								...
								<form action="" method="post" class="form-group col-md-9">
									...
									<font face="arial" color="skyblue">
									  ...
									  <input type="textarea" class="form-control" name="feedback" id="feedback" placeholder="Feedback">
									</font>
									<br>									
							...
							<td width="50%">
								<img src="Images/alex-suprun-d304gprGG5k-unsplash.jpg" align="left" width="100%">
							</td>
                    </tr>
                </table>
            </td>
