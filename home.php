                ...
                <table border="0" width="85%" cellpadding="15" cellspacing="0" align="center">
                    <tr>
                        <td align="center" valign="middle">
							...
							<tr>
                        <td >
                            <img src="Images/unnamed.jpg"  align="" width="100%">
                        </td>
        ...
        <tr>
            <td>
                <table border="0" width="85%" cellpadding="15" cellspacing="0" align="center">
                    ...
                    <tr>
                        <td width="49%">
                            <img src="Images/mike-lorusso-OuJmGjeCA3Y-unsplash.jpg" alt="Saurabh Shukla"  width="96%">
                        </td>
                        <td width="60%">
        ...
        <tr>
            <td>
                <table border="0" width="85%" cellpadding="15" cellspacing="0" align="center">
                    ...
                    <tr>
                        <td width="33%">
                            <img src="Images/ATI.png" alt="Service1"  width="100%">
                        </td>
                        <td width="33%">
                            <img src="Images/download.jfif" alt="Service1"  width="100%">
                        </td>
                        <td width="33%">
                            <img src="Images/44.jpg" alt="Service1"  width="100%">
                        </td>
                    </tr>
                    <tr>
                        <td>
        ...
        <tr>
            <td>
                <table border="0" width="85%" cellpadding="15" cellspacing="0" align="center">
                    ...
                    <tr>
                        <td height="180" align="center" valign="middle" colspan="3">
                          <a  href="signup.php"><button class="glow-on-hover" type="button">CLICK TO LOGIN</button></a>
                         </td>
                    </tr>           
				</table>
			</td>
